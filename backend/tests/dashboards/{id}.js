...
/**
 * Test for /dashboards/{id}
 */
Test('/dashboards/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getDashboardById get operation', function (t) {
            Mockgen().requests({
                path: '/dashboards/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/dashboards/{id}']['get']['responses']['200']['schema']);
