...
Test('/dashboards/', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getDashboards get operation', function (t) {
            Mockgen().requests({
                path: '/dashboards/',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/dashboards/']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test addDashboard post operation', function (t) {
            Mockgen().requests({
                path: '/dashboards/',
                operation: 'post'
            }, function (err, mock) {
